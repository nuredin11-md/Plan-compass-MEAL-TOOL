...
export function AppSidebar({ activeTab, onTabChange }: AppSidebarProps) {
  return (
    <Sidebar className="border-r border-sidebar-border/50 bg-gradient-to-b from-sidebar/50 to-sidebar">
      <SidebarHeader className="p-4 border-b border-sidebar-border/30 bg-[#8421d9]">
        <div className="flex items-center gap-3 group cursor-pointer">
          ...
          <div className="flex-1">
            <h2 className="text-[19px] font-bold text-sidebar-foreground tracking-wide font-['Georgia']">Hospital M&E</h2>
            <p className="text-xs text-muted-foreground font-medium">Performance Tracker</p>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
        <SidebarGroup className="bg-[#b2c2d5] border border-[#1c64b0]">
